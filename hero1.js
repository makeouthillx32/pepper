document.addEventListener('DOMContentLoaded', function() {
    ...
    if (container) {
        ...
        const icons = [
            { href: 'https://instagram.com', src: 'images/Insta.jpeg', alt: 'Instagram' },
            { href: 'https://twitter.com', src: 'images/X.jpeg', alt: 'Twitter' },
            { href: 'https://youtube.com', src: 'images/Youtube.jpeg', alt: 'YouTube' }
        ];
        icons.forEach(icon => {
